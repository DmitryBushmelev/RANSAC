    ...
    class Program
    {
        static void Main()
        {
            ...
            while (count < Math.Ceiling(N / 2.0))
            {
                ...
                //cosa = cosa/ Math.Sqrt(Math.Pow(cosa, 2) + Math.Pow(cosb, 2) + Math.Sqrt(Math.Pow(cosc, 2)));
                //cosb = cosb / Math.Sqrt(Math.Pow(cosa, 2) + Math.Pow(cosb, 2) + Math.Sqrt(Math.Pow(cosc, 2)));
                //cosc = cosc / Math.Sqrt(Math.Pow(cosa, 2) + Math.Pow(cosb, 2) + Math.Sqrt(Math.Pow(cosc, 2)));
                //Console.WriteLine(Math.Sqrt(Math.Pow(cosa, 2) + Math.Pow(cosb, 2) + Math.Sqrt(Math.Pow(cosc, 2))));

                double prop = random.Next(-1000000, 1000000) / 1000000.0;
                double d = random.Next(1, 100000000) / 1000000.0;
            ...
            while (count < N)
            {
                double A = random.Next(-1000000, 1000000) / 1000000.0;
                double B = random.Next(-1000000, 1000000) / 1000000.0;
                double C = random.Next(-1000000, 1000000) / 1000000.0;
